    ...
    (function() {
        ...
        t.exports = function() {
                    ...
                    for (a in t)
                        if (d.call(t, a))
                            ...
                            !this.options.ignoreDecorators && this.stringify.convertAttKey && 0 === a.indexOf(this.stringify.convertAttKey))
                                u = this.attribute(a.substr(this.stringify.convertAttKey.length), g);
                                ...
                                f(g) ? (u = this.element(a)).element(g) : u = this.element(a, g)
                } else
                    u = !this.options.ignoreDecorators && this.stringify.convertTextKey && 0 === t.indexOf(this.stringify.convertTextKey) ? this.text(n) : !this.options.ignoreDecorators && this.stringify.convertCDataKey && 0 === t.indexOf(this.stringify.convertCDataKey) ? this.cdata(n) : !this.options.ignoreDecorators && this.stringify.convertCommentKey && 0 === t.indexOf(this.stringify.convertCommentKey) ? this.comment(n) : !this.options.ignoreDecorators && this.stringify.convertRawKey && 0 === t.indexOf(this.stringify.convertRawKey) ? this.raw(n) : !this.options.ignoreDecorators && this.stringify.convertPIKey && 0 === t.indexOf(this.stringify.convertPIKey) ? this.instruction(t.substr(this.stringify.convertPIKey.length), n) : this.node(t, e, n);
                if (null == u)
            ...
            t.prototype.instructionBefore = function(t, e) {
                var n, r;
                return n = this.parent.children.indexOf(this),
            ...
            t.prototype.declaration = function(t, e, n) {
                ...
                o = new i(r,t,e,n),
                r.children[0]instanceof i ? r.children[0] = o : r.children.unshift(o),
                r.root() || r
            }
            ,
            t.prototype.doctype = function(t, e) {
                ...
                r = new o(n,t,e),
                i = s = 0,
                u = (l = n.children).length; s < u; i = ++s)
                    if (l[i]instanceof o)
                        return n.children[i] = r,
                        r;
                for (i = a = 0,
                c = (h = n.children).length; a < c; i = ++a)
                    if (h[i].isRoot)
                        return n.children.splice(i, 0, r),
                        r;
            ...
            t.prototype.importDocument = function(t) {
                var e;
                return (e = t.root().clone()).parent = this,
                e.isRoot = !1,
                this.children.push(e),
                this
            }
...
, function(t, e) {
    (function() {
        var e, n, r, i, o, s, a = [].slice, u = {}.hasOwnProperty;
        e = function() {
            var t, e, n, r, o, s;
            if (s = arguments[0],
...
, function(t, e, n) {
    (function() {
        ...
        t.exports = function(t) {
            function n(t, e, r) {
                if (n.__super__.constructor.call(this, t),
                null == e)
                    throw new Error("Missing instruction target");
                this.target = this.stringify.insTarget(e),
        ...
        t.exports = function(t) {
            function n(t, e, i, o) {
                ...
                r(o)) {
                    ...
                    if (null != o.pubID && (this.pubID = this.stringify.dtdPubID(o.pubID)),
    ...
    (function() {
        ...
        t.exports = function(t) {
            function n(t, e, r, i, o, s) {
                ...
                this.elementName = this.stringify.eleName(e),
    ...
    (function() {
        ...
        t.exports = function(t) {
            function n(t, e, i, o) {
                ...
                o = s.standalone),
                e || (e = "1.0"),
                this.version = this.stringify.xmlVersion(e),
...
, function(t, e, n) {
    (function() {
        ...
        t.exports = function(t) {
            ...
            n.prototype.clone = function() {
                var t, e, n, r;
                for (e in (n = Object.create(this)).isRoot && (n.documentObject = null),
                n.attributes = {},
                r = this.attributes)
                    a.call(r, e) && (t = r[e],
                    n.attributes[e] = t.clone());
                return n.children = [],
                this.children.forEach(function(t) {
                    var e;
                    return (e = t.clone()).parent = n,
                    n.children.push(e)
                }),
                n
            }
            ...
            n.prototype.attribute = function(t, n) {
                ...
                o(t))
                    ...
                    i(n) && (n = n.apply()),
                    this.options.skipNullAttributes && null == n || (this.attributes[t] = new e(this,t,n));
                return this
            }
            ,
...
, function(t, e, n) {
    ...
    (function(e, r, i) {
            ...
            this.onwrite = function(t) {
                !function(t, e) {
                    ...
                    e)
                        ...
                        var s = E(n);
                        s || n.corked || n.bufferProcessing || !n.bufferedRequest || v(t, n),
        ...
        function _(t) {
            if (a = a || n(2),
            !(d.call(_, this) || this instanceof a))
                return new _(t);
        ...
        _.prototype.write = function(t, e, n) {
            var r, i = this._writableState, s = !1, a = !i.objectMode && (r = t,
            f.isBuffer(r) || r instanceof p);
        ...
        _.prototype.uncork = function() {
            ...
            t.corked && (t.corked--,
            t.writing || t.corked || t.finished || t.bufferProcessing || !t.bufferedRequest || v(this, t))
        }
        ,
    ...
    (function() {
        ...
        t.exports = function(t) {
            ...
            n.prototype.declaration = function(t, e) {
                var n;
                return n = this.space(e),
                n += '<?xml version="' + t.version + '"',
                null != t.encoding && (n += ' encoding="' + t.encoding + '"'),
                null != t.standalone && (n += ' standalone="' + t.standalone + '"'),
            ...
            n.prototype.docType = function(t, n) {
                ...
                t.pubID && t.sysID ? f += ' PUBLIC "' + t.pubID + '" "' + t.sysID + '"' : t.sysID && (f += ' SYSTEM "' + t.sysID + '"'),
                t.children.length > 0) {
                    for (f += " [",
                    f += this.newline,
                    c = 0,
                    l = (p = t.children).length; c < l; c++)
                        u = p[c],
                        f += function() {
                            switch (!1) {
                            case !(u instanceof i):
            ...
            n.prototype.element = function(t, n) {
                ...
                if (0 === t.children.length || t.children.every(function(t) {
                    ...
                    g += ">",
                    g += t.children[0].value,
                    g += "</" + t.name + ">" + this.newline;
                else {
                    if (this.dontprettytextnodes)
                        for (s = 0,
                        u = (_ = t.children).length; s < u; s++)
                            if (null != (o = _[s]).value) {
                                this.textispresent++,
                                v = !0;
                                break
            ...
            n.prototype.processingInstruction = function(t, e) {
                var n;
                return n = this.space(e) + "<?" + t.target,
                t.value && (n += " " + t.value),
            ...
            n.prototype.dtdAttList = function(t, e) {
                var n;
                return n = this.space(e) + "<!ATTLIST " + t.elementName + " " + t.attributeName + " " + t.attributeType,
                "#DEFAULT" !== t.defaultValueType && (n += " " + t.defaultValueType),
            ...
            n.prototype.dtdEntity = function(t, e) {
                var n;
                return n = this.space(e) + "<!ENTITY",
                t.pe && (n += " %"),
                n += " " + t.name,
                t.value ? n += ' "' + t.value + '"' : (t.pubID && t.sysID ? n += ' PUBLIC "' + t.pubID + '" "' + t.sysID + '"' : t.sysID && (n += ' SYSTEM "' + t.sysID + '"'),
            ...
            n.prototype.dtdNotation = function(t, e) {
                var n;
                return n = this.space(e) + "<!NOTATION " + t.name,
                t.pubID && t.sysID ? n += ' PUBLIC "' + t.pubID + '" "' + t.sysID + '"' : t.pubID ? n += ' PUBLIC "' + t.pubID + '"' : t.sysID && (n += ' SYSTEM "' + t.sysID + '"'),
                n += this.spacebeforeslash + ">" + this.newline
            }
            ,
...
, function(t, e, n) {
    ...
    (function(e, r) {
        ...
        function _(t, e) {
            ...
            this.decoder = null,
            this.encoding = null,
            t.encoding && (d || (d = n(22).StringDecoder),
        ...
        function w(t, e, n, r, i) {
            ...
            function(t, e) {
                ...
                var n;
                r = e,
                c.isBuffer(r) || r instanceof l || "string" == typeof e || void 0 === e || t.objectMode || (n = new TypeError("Invalid non-string/buffer chunk"));
                var r;
                return n
            }(s, e)),
            ...
            s.objectMode || 0 !== e.length ? v(t, s, e, !1) : D(t, s)) : v(t, s, e, !1))) : r || (s.reading = !1));
            return function(t) {
        ...
        b.prototype.read = function(t) {
            ...
            0 === t && e.needReadable && (e.length >= e.highWaterMark || e.ended))
                ...
                0 === e.length && e.ended ? P(this) : x(this),
                null;
            if (0 === (t = T(t, e)) && e.ended)
                return 0 === e.length && P(this),
                null;
        ...
        b.prototype.pipe = function(t, e) {
            ...
            function y(e) {
                p("ondata"),
                d = !1,
                !1 !== t.write(e) || d || ((1 === o.pipesCount && o.pipes === t || o.pipesCount > 1 && -1 !== L(o.pipes, t)) && !f && (p("false write response, pause", n._readableState.awaitDrain),
        ...
        b.prototype.on = function(t, e) {
            ...
            if ("data" === t)
                ...
                r.emittedReadable = !1,
                r.reading ? r.length && x(this) : i.nextTick(N, this))
            }
            return n
        }
        ,
    ...
    (function() {
        ...
        t.exports = function() {
            function t(t) {
                ...
                this.pretty ? (this.indent = null != (i = t.indent) ? i : "  ",
                this.newline = null != (o = t.newline) ? o : "\n",
                this.offset = null != (s = t.offset) ? s : 0,
                this.dontprettytextnodes = null != (a = t.dontprettytextnodes) ? a : 0) : (this.indent = "",
                this.newline = "",
                this.offset = 0,
                this.dontprettytextnodes = 0),
                this.spacebeforeslash = null != (u = t.spacebeforeslash) ? u : "",
            ...
            return t.prototype.set = function(t) {
                ...
                this.pretty ? (this.indent = "indent"in t ? t.indent : "  ",
                this.newline = "newline"in t ? t.newline : "\n",
                this.offset = "offset"in t ? t.offset : 0,
                this.dontprettytextnodes = "dontprettytextnodes"in t ? t.dontprettytextnodes : 0) : (this.indent = "",
                this.newline = "",
                this.offset = 0,
                this.dontprettytextnodes = 0),
...
, function(t, e) {
    (function() {
        ...
        t.exports = function() {
            function t(t) {
                var r, i, o;
                for (r in this.assertLegalChar = e(this.assertLegalChar, this),
                t || (t = {}),
...
, function(t, e) {
    (function() {
        t.exports = function() {
            function t(t, e, n) {
                if (this.options = t.options,
                this.stringify = t.stringify,
                null == e)
                    throw new Error("Missing attribute name of element " + t.name);
                if (null == n)
                    throw new Error("Missing attribute value for attribute " + e + " of element " + t.name);
...
, function(t, e, n) {
    (function(t, e) {
        !function(t, n) {
            "use strict";
            if (!t.setImmediate) {
                var r, i, o, s, a, u = 1, c = {}, l = !1, h = t.document, f = Object.getPrototypeOf && Object.getPrototypeOf(t);
...
, function(t, e) {
    ...
    e.write = function(t, e, n, r, i, o) {
        var s, a, u, c = 8 * o - i - 1, l = (1 << c) - 1, h = l >> 1, f = 23 === i ? Math.pow(2, -24) - Math.pow(2, -77) : 0, p = r ? 0 : o - 1, d = r ? 1 : -1, y = e < 0 || 0 === e && 1 / e < 0 ? 1 : 0;
        for (e = Math.abs(e),
...
, function(t, e, n) {
    ...
    e.toByteArray = function(t) {
        for (var e, n = c(t), r = n[0], s = n[1], a = new o(function(t, e, n) {
            return 3 * (e + n) / 4 - n
        }(0, r, s)), u = 0, l = s > 0 ? r - 4 : r, h = 0; h < l; h += 4)
            e = i[t.charCodeAt(h)] << 18 | i[t.charCodeAt(h + 1)] << 12 | i[t.charCodeAt(h + 2)] << 6 | i[t.charCodeAt(h + 3)],
            a[u++] = e >> 16 & 255,
            a[u++] = e >> 8 & 255,
            a[u++] = 255 & e;
        2 === s && (e = i[t.charCodeAt(h)] << 2 | i[t.charCodeAt(h + 1)] >> 4,
        a[u++] = 255 & e);
        1 === s && (e = i[t.charCodeAt(h)] << 10 | i[t.charCodeAt(h + 1)] << 4 | i[t.charCodeAt(h + 2)] >> 2,
        a[u++] = e >> 8 & 255,
        a[u++] = 255 & e);
        return a
    }
    ...
    (function(t) {
        !function(e) {
            ...
            function o(t, n) {
                ...
                this.attribList = [],
                this.opt.xmlns && (this.ns = Object.create(f)),
            ...
            o.prototype = {
                ...
                write: function(t) {
                    if (this.error)
                        throw this.error;
                    if (this.closed)
                        return C(this, "Cannot write after close. Assign an onready handler.");
                    if (null === t)
                        return P(this);
                    ...
                    r; )
                        ...
                        this.state) {
                        case A.BEGIN:
                            if (this.state = A.BEGIN_WHITESPACE,
                            "\ufeff" === r)
                                continue;
                            j(this, r);
                            continue;
                        ...
                        case A.TEXT:
                            if (this.sawRoot && !this.closedRoot) {
                                for (var o = n - 1; r && "<" !== r && "&" !== r; )
                                    (r = Y(t, n++)) && this.trackPosition && (this.position++,
                                    "\n" === r ? (this.line++,
                                    this.column = 0) : this.column++);
                                this.textNode += t.substring(o, n - 1)
                            }
                            "<" !== r || this.sawRoot && this.closedRoot && !this.strict ? (m(r) || this.sawRoot && !this.closedRoot || k(this, "Text data outside of root node."),
                            "&" === r ? this.state = A.TEXT_ENTITY : this.textNode += r) : (this.state = A.OPEN_WAKA,
                        ...
                        case A.SCRIPT_ENDING:
                            "/" === r ? this.state = A.CLOSE_TAG : (this.script += "<" + r,
                            this.state = A.SCRIPT);
                            continue;
                        case A.OPEN_WAKA:
                            if ("!" === r)
                                this.state = A.SGML_DECL,
                                this.sgmlDecl = "";
                            else if (m(r))
                                ;
                            else if (w(p, r))
                                this.state = A.OPEN_TAG,
                                this.tagName = r;
                            else if ("/" === r)
                                this.state = A.CLOSE_TAG,
                                this.tagName = "";
                            else if ("?" === r)
                                this.state = A.PROC_INST,
                            ...
                            continue;
                        case A.SGML_DECL:
                            (this.sgmlDecl + r).toUpperCase() === u ? (N(this, "onopencdata"),
                            this.state = A.CDATA,
                            this.sgmlDecl = "",
                            this.cdata = "") : this.sgmlDecl + r === "--" ? (this.state = A.COMMENT,
                            this.comment = "",
                            this.sgmlDecl = "") : (this.sgmlDecl + r).toUpperCase() === c ? (this.state = A.DOCTYPE,
                            (this.doctype || this.sawRoot) && k(this, "Inappropriately located doctype declaration"),
                            this.doctype = "",
                            this.sgmlDecl = "") : ">" === r ? (N(this, "onsgmldeclaration", this.sgmlDecl),
                            this.sgmlDecl = "",
                            this.state = A.TEXT) : _(r) ? (this.state = A.SGML_DECL_QUOTED,
                            this.sgmlDecl += r) : this.sgmlDecl += r;
                            continue;
                        case A.SGML_DECL_QUOTED:
                            r === this.q && (this.state = A.SGML_DECL,
                            this.q = ""),
                            this.sgmlDecl += r;
                            continue;
                        case A.DOCTYPE:
                            ">" === r ? (this.state = A.TEXT,
                            N(this, "ondoctype", this.doctype),
                            this.doctype = !0) : (this.doctype += r,
                            "[" === r ? this.state = A.DOCTYPE_DTD : _(r) && (this.state = A.DOCTYPE_QUOTED,
                            this.q = r));
                            continue;
                        ...
                        case A.DOCTYPE_DTD:
                            this.doctype += r,
                            "]" === r ? this.state = A.DOCTYPE : _(r) && (this.state = A.DOCTYPE_DTD_QUOTED,
                            this.q = r);
                            continue;
                        case A.DOCTYPE_DTD_QUOTED:
                            this.doctype += r,
                            r === this.q && (this.state = A.DOCTYPE_DTD,
                            this.q = "");
                            continue;
                        case A.COMMENT:
                        ...
                        case A.COMMENT_ENDING:
                            "-" === r ? (this.state = A.COMMENT_ENDED,
                            this.comment = O(this.opt, this.comment),
                            this.comment && N(this, "oncomment", this.comment),
                            this.comment = "") : (this.comment += "-" + r,
                            this.state = A.COMMENT);
                            continue;
                        case A.COMMENT_ENDED:
                            ">" !== r ? (k(this, "Malformed comment"),
                            this.comment += "--" + r,
                            this.state = A.COMMENT) : this.state = A.TEXT;
                            continue;
                        case A.CDATA:
                            "]" === r ? this.state = A.CDATA_ENDING : this.cdata += r;
                            continue;
                        case A.CDATA_ENDING:
                            "]" === r ? this.state = A.CDATA_ENDING_2 : (this.cdata += "]" + r,
                            this.state = A.CDATA);
                            continue;
                        case A.CDATA_ENDING_2:
                            ">" === r ? (this.cdata && N(this, "oncdata", this.cdata),
                            N(this, "onclosecdata"),
                            this.cdata = "",
                            this.state = A.TEXT) : "]" === r ? this.cdata += "]" : (this.cdata += "]]" + r,
                            this.state = A.CDATA);
                            continue;
                        case A.PROC_INST:
                        ...
                        case A.PROC_INST_ENDING:
                            ...
                            this.procInstName = this.procInstBody = "",
                            this.state = A.TEXT) : (this.procInstBody += "?" + r,
                            this.state = A.PROC_INST_BODY);
                            continue;
                        case A.OPEN_TAG:
                            w(d, r) ? this.tagName += r : (L(this),
                            ">" === r ? B(this) : "/" === r ? this.state = A.OPEN_TAG_SLASH : (m(r) || k(this, "Invalid character in tag name"),
                            this.state = A.ATTRIB));
                            continue;
                        case A.OPEN_TAG_SLASH:
                            ">" === r ? (B(this, !0),
                            U(this)) : (k(this, "Forward-slash in opening tag not followed by >"),
                            this.state = A.ATTRIB);
                            continue;
                        case A.ATTRIB:
                            if (m(r))
                                continue;
                            ">" === r ? B(this) : "/" === r ? this.state = A.OPEN_TAG_SLASH : w(p, r) ? (this.attribName = r,
                            this.attribValue = "",
                            this.state = A.ATTRIB_NAME) : k(this, "Invalid attribute name");
                            continue;
                        case A.ATTRIB_NAME:
                            "=" === r ? this.state = A.ATTRIB_VALUE : ">" === r ? (k(this, "Attribute without value"),
                            this.attribValue = this.attribName,
                            M(this),
                            B(this)) : m(r) ? this.state = A.ATTRIB_NAME_SAW_WHITE : w(d, r) ? this.attribName += r : k(this, "Invalid attribute name");
                            continue;
                        case A.ATTRIB_NAME_SAW_WHITE:
                            if ("=" === r)
                                this.state = A.ATTRIB_VALUE;
                            else {
                                if (m(r))
                                    continue;
                                k(this, "Attribute without value"),
                                ...
                                this.attribName = "",
                                ">" === r ? B(this) : w(p, r) ? (this.attribName = r,
                                this.state = A.ATTRIB_NAME) : (k(this, "Invalid attribute name"),
                                this.state = A.ATTRIB)
                            }
                            continue;
                        case A.ATTRIB_VALUE:
                            if (m(r))
                                continue;
                            _(r) ? (this.q = r,
                            this.state = A.ATTRIB_VALUE_QUOTED) : (k(this, "Unquoted attribute value"),
                            this.state = A.ATTRIB_VALUE_UNQUOTED,
                            this.attribValue = r);
                            continue;
                        case A.ATTRIB_VALUE_QUOTED:
                            ...
                            M(this),
                            this.q = "",
                            this.state = A.ATTRIB_VALUE_CLOSED;
                            continue;
                        case A.ATTRIB_VALUE_CLOSED:
                            m(r) ? this.state = A.ATTRIB : ">" === r ? B(this) : "/" === r ? this.state = A.OPEN_TAG_SLASH : w(p, r) ? (k(this, "No whitespace between attributes"),
                            this.attribName = r,
                            this.attribValue = "",
                            this.state = A.ATTRIB_NAME) : k(this, "Invalid attribute name");
                            continue;
                        case A.ATTRIB_VALUE_UNQUOTED:
                            ...
                            M(this),
                            ">" === r ? B(this) : this.state = A.ATTRIB;
                            continue;
                        case A.CLOSE_TAG:
                            if (this.tagName)
                                ">" === r ? U(this) : w(d, r) ? this.tagName += r : this.script ? (this.script += "</" + this.tagName,
                                this.tagName = "",
                                this.state = A.SCRIPT) : (m(r) || k(this, "Invalid tagname in closing tag"),
                                this.state = A.CLOSE_TAG_SAW_WHITE);
                            else {
                                if (m(r))
                                    continue;
                                v(p, r) ? this.script ? (this.script += "</" + r,
                                this.state = A.SCRIPT) : k(this, "Invalid tagname in closing tag.") : this.tagName = r
                            }
                            continue;
                        ...
                        case A.ATTRIB_VALUE_ENTITY_U:
                            ...
                            case A.TEXT_ENTITY:
                                ...
                                break;
                            case A.ATTRIB_VALUE_ENTITY_Q:
                                a = A.ATTRIB_VALUE_QUOTED,
                                l = "attribValue";
                                break;
                            case A.ATTRIB_VALUE_ENTITY_U:
                                a = A.ATTRIB_VALUE_UNQUOTED,
                                l = "attribValue"
                            }
                            ";" === r ? (this[l] += F(this),
                            this.entity = "",
                            this.state = a) : w(this.entity.length ? g : y, r) ? this.entity += r : (k(this, "Invalid character in entity name"),
                ...
                flush: function() {
                    ...
                    t.cdata = ""),
                    "" !== t.script && (N(t, "onscript", t.script),
                    t.script = "")
                }
            };
            try {
            ...
            function P(t) {
                ...
                t.state !== A.BEGIN && t.state !== A.BEGIN_WHITESPACE && t.state !== A.TEXT && C(t, "Unexpected end"),
                S(t),
                t.c = "",
                t.closed = !0,
                I(t, "onend"),
                    ...
                    if (t.opt.xmlns) {
                        ...
                        if ("xmlns" === n)
                            if ("xml" === r && t.attribValue !== l)
                                k(t, "xml: prefix must be bound to " + l + "\nActual: " + t.attribValue);
                            else if ("xmlns" === r && t.attribValue !== h)
                                k(t, "xmlns: prefix must be bound to " + h + "\nActual: " + t.attribValue);
                            else {
                                var i = t.tag
            ...
            function B(t, e) {
                if (t.opt.xmlns) {
                    ...
                    n.local = r.local,
                    n.uri = n.ns[r.prefix] || "",
                    n.prefix && !n.uri && (k(t, "Unbound namespace prefix: " + JSON.stringify(t.tagName)),
                    n.uri = r.prefix);
                    ...
                    for (var o = 0, s = t.attribList.length; o < s; o++) {
                        ...
                        h && "xmlns" !== h && !p && (k(t, "Unbound namespace prefix: " + JSON.stringify(h)),
                        d.uri = h),
                ...
                t.tags.push(t.tag),
                N(t, "onopentag", t.tag),
                e || (t.noscript || "script" !== t.tagName.toLowerCase() ? t.state = A.TEXT : t.state = A.SCRIPT,
                t.tag = null,
                t.tagName = ""),
                t.attribName = t.attribValue = "",
                t.attribList.length = 0
            ...
            function U(t) {
                if (!t.tagName)
                    return k(t, "Weird empty close tag."),
                    t.textNode += "</>",
                    void (t.state = A.TEXT);
                if (t.script) {
                    if ("script" !== t.tagName)
                ...
                if (e < 0)
                    return k(t, "Unmatched closing tag: " + t.tagName),
            ...
            function F(t) {
                ...
                i = (e = parseInt(n, 16)).toString(16)) : (n = n.slice(1),
                i = (e = parseInt(n, 10)).toString(10))),
                n = n.replace(/^0+/, ""),
                isNaN(e) || i.toLowerCase() !== n ? (k(t, "Invalid character entity"),
                "&" + t.entity + ";") : String.fromCodePoint(e))
            }
            function j(t, e) {
                "<" === e ? (t.state = A.OPEN_WAKA,
                t.startTagPosition = t.position) : m(e) || (k(t, "Non-whitespace before first tag."),
                t.textNode = e,
                t.state = A.TEXT)
            }
            function Y(t, e) {
                var n = "";
                return e < t.length && (n = t.charAt(e)),
                n
            }
            A = e.STATE,
            ...
            T = Math.floor,
            x = function() {
                var t, e, n = [], r = -1, i = arguments.length;
                if (!i)
                    return "";
                for (var o = ""; ++r < i; ) {
                    ...
                    s <= 65535 ? n.push(s) : (t = 55296 + ((s -= 65536) >> 10),
                    e = s % 1024 + 56320,
                    n.push(t, e)),
                    (r + 1 === i || n.length > 16384) && (o += E.apply(null, n),
                    n.length = 0)
                }
                return o
            }
...
, function(t, e, n) {
    (function() {
        ...
        e.Parser = function(n) {
            function f(t) {
                var n, i, o;
                if (this.parseString = l(this.parseString, this),
            ...
            f.prototype.processAsync = function() {
                var t, e;
                try {
                    return this.remaining.length <= this.options.chunkSize ? (t = this.remaining,
                    this.remaining = "",
                    this.saxParser = this.saxParser.write(t),
                    this.saxParser.close()) : (t = this.remaining.substr(0, this.options.chunkSize),
                    this.remaining = this.remaining.substr(this.options.chunkSize, this.remaining.length),
                    this.saxParser = this.saxParser.write(t),
                    c(this.processAsync))
                } catch (t) {
                    if (e = t,
                    !this.saxParser.errThrown)
            ...
            f.prototype.assignOrPush = function(t, e, n) {
                return e in t ? (t[e]instanceof Array || (t[e] = [t[e]]),
                t[e].push(n)) : this.options.explicitArray ? t[e] = [n] : t[e] = n
            }
            ,
            f.prototype.reset = function() {
                ...
                this.saxParser.onerror = (i = this,
                function(t) {
                    if (i.saxParser.resume(),
                    !i.saxParser.errThrown)
                        return i.saxParser.errThrown = !0,
                        i.emit("error", t)
                }
                ),
                ...
                this.saxParser.onopentag = function(n) {
                    return function(i) {
                        var o, a, u, c, l;
                        if ((u = {})[e] = "",
                        !n.options.ignoreAttrs)
                            for (o in l = i.attributes)
                                h.call(l, o) && (t in u || n.options.mergeAttrs || (u[t] = {}),
                                a = n.options.attrValueProcessors ? s(n.options.attrValueProcessors, i.attributes[o], o) : i.attributes[o],
                                c = n.options.attrNameProcessors ? s(n.options.attrNameProcessors, o) : o,
                                n.options.mergeAttrs ? n.assignOrPush(u, c, a) : u[t][c] = a);
                        return u["#name"] = n.options.tagNameProcessors ? s(n.options.tagNameProcessors, i.name) : i.name,
                        n.options.xmlns && (u[n.options.xmlnskey] = {
                            uri: i.uri,
                            local: i.local
                        }),
                        r.push(u)
                    ...
                    return function() {
                        ...
                        t.options.explicitChildren && !t.options.mergeAttrs && "object" == typeof l)
                            if (t.options.preserveChildrenOrder) {
                                if (d) {
                                    for (a in d[t.options.childkey] = d[t.options.childkey] || [],
                                    f = {},
                                    l)
                                        h.call(l, a) && (f[a] = l[a]);
                                ...
                                u = {},
                                t.options.attrkey in l && (u[t.options.attrkey] = l[t.options.attrkey],
                                delete l[t.options.attrkey]),
                                !t.options.charsAsChildren && t.options.charkey in l && (u[t.options.charkey] = l[t.options.charkey],
                                delete l[t.options.charkey]),
                                Object.getOwnPropertyNames(l).length > 0 && (u[t.options.childkey] = l),
                                l = u;
                        return r.length > 0 ? t.assignOrPush(d, c, l) : (t.options.explicitRoot && (p = l,
                        (l = {})[c] = p),
                        t.resultObject = l,
                        t.saxParser.ended = !0,
                        t.emit("end", t.resultObject))
                ...
                n = function(t) {
                    return function(n) {
                        ...
                        if (o = r[r.length - 1])
                            return o[e] += n,
                            t.options.explicitChildren && t.options.preserveChildrenOrder && t.options.charsAsChildren && (t.options.includeWhiteChars || "" !== n.replace(/\\n/g, "").trim()) && (o[t.options.childkey] = o[t.options.childkey] || [],
                            (i = {
                                "#name": "__text__"
                            })[e] = n,
            ...
            f.prototype.parseString = function(e, n) {
                ...
                try {
                    return "" === (e = e.toString()).trim() ? (this.emit("end", null),
                    !0) : (e = t.stripBOM(e),
                    this.options.async ? (this.remaining = e,
                    c(this.processAsync),
                    this.saxParser) : this.saxParser.write(e).close())
                } catch (t) {
                    if (r = t,
        ...
        e.parseString = function(t, n, r) {
            var i, o;
            return null != r ? ("function" == typeof r && (i = r),
            "object" == typeof n && (o = n)) : ("function" == typeof n && (i = n),
            o = {}),
    ...
    (function() {
        ...
        t.exports = function(t) {
            ...
            n.prototype.document = function(t) {
                var e, n, i, o, s, a, l, f;
                for (n = 0,
                o = (a = t.children).length; n < o; n++)
                    (e = a[n]).isLastRootNode = !1;
                for (t.children[t.children.length - 1].isLastRootNode = !0,
                f = [],
                i = 0,
                s = (l = t.children).length; i < s; i++)
                    switch (e = l[i],
                    !1) {
                    case !(e instanceof u):
            ...
            n.prototype.docType = function(t, n) {
                ...
                t.pubID && t.sysID ? this.stream.write(' PUBLIC "' + t.pubID + '" "' + t.sysID + '"') : t.sysID && this.stream.write(' SYSTEM "' + t.sysID + '"'),
                t.children.length > 0) {
                    for (this.stream.write(" ["),
                    this.stream.write(this.endline(t)),
                    c = 0,
                    l = (f = t.children).length; c < l; c++)
                        switch (u = f[c],
                        !1) {
                        case !(u instanceof i):
            ...
            n.prototype.dtdEntity = function(t, e) {
                ...
                this.stream.write(" " + t.name),
                t.value ? this.stream.write(' "' + t.value + '"') : (t.pubID && t.sysID ? this.stream.write(' PUBLIC "' + t.pubID + '" "' + t.sysID + '"') : t.sysID && this.stream.write(' SYSTEM "' + t.sysID + '"'),
    ...
    (function() {
        ...
        t.exports = function() {
            function t(t, e, n) {
                var r;
                t || (t = {}),
                t.writer ? b(t.writer) && (r = t.writer,
                t.writer = new d(r)) : t.writer = new d(t),
                this.options = t,
                this.writer = t.writer,
                this.stringify = new y(t),
            ...
            return t.prototype.node = function(t, e, n) {
                ...
                _(e) || (n = (r = [e, n])[0],
                e = r[1]),
                this.currentNode = new h(this,t,e),
            ...
            t.prototype.attribute = function(t, n) {
                ...
                _(t))
                    ...
                    m(n) && (n = n.apply()),
                    this.options.skipNullAttributes && null == n || (this.currentNode.attributes[t] = new e(this,t,n));
                return this
            }
            ,
            t.prototype.text = function(t) {
            ...
            t.prototype.instruction = function(t, e) {
                ...
                Array.isArray(t))
                    ...
                    m(e) && (e = e.apply()),
                    s = new f(this,t,e),
                    this.onData(this.writer.processingInstruction(s, this.currentLevel + 1));
                return this
            }
            ,
            t.prototype.declaration = function(t, e, n) {
                ...
                return r = new c(this,t,e,n),
                this.onData(this.writer.declaration(r, this.currentLevel + 1)),
                this
            }
            ,
            t.prototype.doctype = function(t, e, n) {
                ...
                return this.currentNode = new l(this,e,n),
            ...
            t.prototype.dtdElement = function(t, e) {
                ...
                return this.openCurrent(),
                n = new s(this,t,e),
                this.onData(this.writer.dtdElement(n, this.currentLevel + 1)),
                this
            }
            ,
            t.prototype.attList = function(t, e, n, r, i) {
                ...
                this.onData(this.writer.dtdAttList(s, this.currentLevel + 1)),
                this
            }
            ,
            t.prototype.entity = function(t, e) {
                ...
                return this.openCurrent(),
                n = new a(this,!1,t,e),
                this.onData(this.writer.dtdEntity(n, this.currentLevel + 1)),
                this
            }
            ,
            ...
            t.prototype.notation = function(t, e) {
                ...
                return this.openCurrent(),
                n = new u(this,t,e),
                this.onData(this.writer.dtdNotation(n, this.currentLevel + 1)),
                this
            }
            ,
            t.prototype.up = function() {
            ...
            t.prototype.openNode = function(t) {
                if (!t.isOpen)
                    return !this.root && 0 === this.currentLevel && t instanceof h && (this.root = t),
            ...
            t.prototype.closeNode = function(t) {
                if (!t.isClosed)
                    return this.onData(this.writer.closeNode(t, this.currentLevel)),
                    t.isClosed = !0
            }
            ,
    ...
    (function() {
        ...
        t.exports = function(t) {
            ...
            n.prototype.end = function(t) {
                var e;
                return t ? o(t) && (e = t,
                t = this.options.writer.set(e)) : t = this.options.writer,
                t.document(this)
            }
            ,
            n.prototype.toString = function(t) {
...
, function(t, e, n) {
    (function() {
        ...
        t.exports.create = function(t, n, r, i) {
            ...
            return i = s({}, n, r, i),
            a = (o = new e(i)).element(t),
            i.headless || (o.declaration(i),
    ...
    (function() {
        ...
        e.Builder = function() {
            ...
            return e.prototype.buildObject = function(e) {
                var n, i, u, c, l, h;
                return n = this.options.attrkey,
                i = this.options.charkey,
                1 === Object.keys(e).length && this.options.rootName === r[.2].rootName ? e = e[l = Object.keys(e)[0]] : l = this.options.rootName,
                h = this,
                u = function(t, e) {
                    var r, c, l, f, p, d;
                    if ("object" != typeof e)
                        h.options.cdata && o(e) ? t.raw(s(e)) : t.txt(e);
                        ...
                        for (p in e)
                            if (a.call(e, p))
                                ...
                                p === n) {
                                    ...
                                    t = h.options.cdata && o(c) ? t.raw(s(c)) : t.txt(c);
                                else if (Array.isArray(c))
                                    for (f in c)
                                        a.call(c, f) && (t = "string" == typeof (l = c[f]) ? h.options.cdata && o(l) ? t.ele(p).raw(s(l)).up() : t.ele(p, l).up() : u(t.ele(p), l).up());
                                else
                                    "object" == typeof c ? t = u(t.ele(p), c).up() : "string" == typeof c && h.options.cdata && o(c) ? t = t.ele(p).raw(s(c)).up() : (null == c && (c = ""),
...
, function(t, e, n) {
    ...
    (function() {
        var t = "d3.layout.phylotree.event";
        function e(t, e) {
            return t[e] || !1
        }
        function n(t) {
        ...
        function c(t, e, n) {
            ...
            if (t.radial()) {
                ...
                r = [r[1] + 2 * i, r[0] + 2 * i + o],
                e && e.selectAll("." + t.css_classes()["tree-container"]).attr("transform", "translate (" + i + "," + (i + o) + ")")
            } else
                r = [r[1] + ("fit-to-size" != t.options()["left-right-spacing"] ? t.pad_width() : 0), r[0] + ("fit-to-size" != t.options()["top-bottom-spacing"] ? t.pad_height() : 0)];
            return e && (n && (e = e.transition(100)),
            e.attr("height", r[1]).attr("width", r[0])),
            r
        }
        function l(t) {
        ...
        function g(t, e) {
            ...
            function r() {
                ...
                t.children.push(n[n.length - 1]),
                n[n.length - 1].original_child_order = t.children.length
            }
            function i(e) {
                return {
                    json: null,
            ...
            n.push(h);
            for (var f, p = /\s/, d = 0; d < t.length; d++)
                try {
                    var y = t[d];
                    switch (o) {
                    case 0:
                    ...
                    case 3:
                        if (":" == y)
                            ...
                            try {
                                f = void 0,
                                f = n.pop(),
                                e && "children"in f ? f.bootstrap_values = s : f.name = s,
                                f.attribute = a,
                                f.annotation = u,
                                s = "",
                                a = "",
            ...
            return 1 != n.length ? i(t.length - 1) : (s.length && (h.name = s),
            {
                json: h,
                error: null
            })
        ...
        function b(e, n) {
            var r = new CustomEvent(t,{
                detail: ["count_update", n, e.count_handler()]
            });
        ...
        d3.layout.newick_parser = function(t, e) {
            return g(t, e)
        }
        ,
        d3.layout.phylotree = function(w) {
            var x = m
              , A = {}
              , D = d3.layout.hierarchy().sort(null).value(null)
              , I = [1, 1]
              , N = [1, 1]
              , S = function(t, e) {
                return 0
            ...
            function et(t, e) {
                ...
                (n = "root" == t.name ? {
                    ...
                    function e(t, n) {
                        t.clade && (t.clade.forEach(e),
                        t.children = t.clade,
                        delete t.clade),
                        t.original_child_order = n + 1,
                        t.branch_length && (t.attribute = t.branch_length[0]),
                        t.taxonomy && (t.name = t.taxonomy[0].scientific_name[0]),
                        t.annotation = ""
                    }
                    var n;
                    return i(t, function(t, r) {
                        (n = r.phyloxml.phylogeny[0].clade[0]).name = "root",
                        e(n)
                    }),
                    {
                        json: n,
                    ...
                    Y = [];
                return et.placenodes(),
                z = et.links(Y),
                et
            }
            return draw_branch = Z,
            draw_scale_bar = null,
            rescale_node_span = 1,
            ...
            radial_mapper = function(t, e) {
                return {
                    x: radial_center + t * Math.sin(e),
                    y: radial_center + t * Math.cos(e)
                }
            }
            ,
            ...
            cartesian_to_polar = function(t, e, n) {
                t.radius = e * (t.radius + n),
                t.angle || (t.angle = 2 * Math.PI * t.x * G[0] / I[0]);
            ...
            polar_to_cartesian = function(t, e) {
                return r = Math.sqrt(Math.pow(t, 2) + Math.pow(e, 2)),
                a = Math.atan2(e, t),
                [r, a]
            }
            ,
            A.container = w || "body",
            et.placenodes = function() {
                var t = 0
                  , e = [[0, 0], [0, 0]]
                  , n = null
                  , r = 0
                ...
                function p(t) {
                    ...
                    if (t.x = t.children.map(d).reduce(function(t, n) {
                        return "number" == typeof n ? t + n : (e += 1,
                        t)
                    }, 0),
                    e == t.children.length)
                        return t.notshown = !0,
                ...
                function d(d) {
                    if (!o(d)) {
                        ...
                        if (y) {
                            ...
                            t = d.x = t + S(n, d) + .5 * (r + g),
                            e[1][1] = Math.max(e[1][1], d.y),
                            e[1][0] = Math.min(e[1][0], d.y - .5 * g),
                            e[0][1] = c ? Math.max(e[0][1], i + (d.x - i) * F.compression + s + (.5 * g + S(n, d)) * F.compression) : Math.max(e[0][1], t + .5 * g + S(n, d)),
                            n = d,
                            r = g
                        } else {
                            if (f(d) && !c) {
                                ...
                                c = !1,
                                "number" == typeof d.x) {
                                    d.x = i + (d.x - i) * F.compression + s,
                                    d.collapsed = [[d.x, d.y]];
                                    var m = function(e) {
                                        e.hidden = !0,
                                        l(e) ? (t = e.x = i + (e.x - i) * F.compression + s,
                                        d.collapsed.push([e.x, e.y])) : e.children.map(m)
                                    };
                                    t = i,
                                    m(d),
                                    d.collapsed.splice(1, 0, [i, d.y]),
                                    d.collapsed.push([t, d.y]),
                                    d.collapsed.push([d.x, d.y]),
                                    d.hidden = !1
                                }
                            } else
                                p(d)
                ...
                var y = !1;
                function g() {
                    if (et.radial() && y && (Q[1] = 0),
                    "fixed-step" == F["left-right-spacing"])
                        I[1] = h * X[1],
                        G[1] = (I[1] - Q[1] - F["left-offset"]) / e[1][1],
                        label_width = et._label_width(shown_font_size),
                        et.radial();
                    else {
                        label_width = et._label_width(shown_font_size),
                        y = !0;
                        var t = I[1] - Q[1] - F["left-offset"];
                        .5 * t < label_width && (shown_font_size *= .5 * t / label_width,
                        label_width = .5 * t),
                        G[1] = (I[1] - Q[1] - F["left-offset"] - label_width) / e[1][1]
                    }
                }
                if (draw_scale_bar = F["show-scale"] && a,
                "fixed-step" == F["top-bottom-spacing"] ? (Q[1] = Math.max(H, -e[1][0] * X[0]),
                I[0] = e[0][1] * X[0],
                G[0] = X[0]) : (G[0] = (I[0] - et.pad_height()) / e[0][1],
                y = !0),
                shown_font_size = Math.min(H, G[0]),
                et.radial()) {
                    draw_branch = tt;
                    var m = null
                      , _ = null
                    ...
                    Y.forEach(function(t) {
                        var e = t.x * G[0];
                        t.angle = 2 * Math.PI * e / v,
                        t.text_angle = t.angle - Math.PI / 2,
                        t.text_angle = t.text_angle > 0 && t.text_angle < Math.PI,
                        t.text_align = t.text_angle ? "end" : "start",
                        t.text_angle = (t.text_angle ? 180 : 0) + 180 * t.angle / Math.PI
                    }),
                    g(),
                    Y.forEach(function(t) {
                        t.radius = t.y * G[1] / I[1],
                        E = Math.max(t.radius, E)
                    });
                    var T = 0;
                            ...
                            if (null !== m) {
                                var n = e - _
                                  , r = function(t, e, n, r, i) {
                                    return i = i || 0,
                                    Math.sqrt((e - t) * (e - t) + 2 * (t + i) * (e + i) * (1 - Math.cos(n - r)))
                                ...
                                if (i > F["max-radius"]) {
                                    var o = n / F["max-radius"]
                                      ...
                                      , u = Math.sqrt(s * s - 4 * a);
                                    T = Math.min(F["annular-limit"] * E, (-s + u) / 2),
                                    w = F["max-radius"]
                                } else
                                    w = Math.max(w, i)
                            }
                    ...
                    radius = Math.min(F["max-radius"], Math.max(v / 2 / Math.PI, w)),
                    y && (radius = Math.min(radius, .5 * (Math.min(v, e[1][1] * G[1]) - label_width) - radius * T)),
                    radial_center = radius_pad_for_bubbles = radius;
                    var x = 1;
                    T && (x = E / (E + T),
                    radius *= x),
                    Y.forEach(function(t) {
                        if (cartesian_to_polar(t, radius, T),
                        E = Math.max(E, t.radius),
                        F["draw-size-bubbles"] ? radius_pad_for_bubbles = Math.max(radius_pad_for_bubbles, t.radius + et.node_bubble_size(t)) : radius_pad_for_bubbles = Math.max(radius_pad_for_bubbles, t.radius),
                        t.collapsed) {
                            t.collapsed = t.collapsed.map(function(t) {
                                var e = {};
                                return e.x = t[0],
                                e.y = t[1],
                                [(e = cartesian_to_polar(e, radius, T)).x, e.y]
                            });
                            var e = t.collapsed[1];
                            t.collapsed = t.collapsed.filter(function(n, r) {
                                return r < 3 || r > t.collapsed.length - 4 || Math.sqrt(Math.pow(n[0] - e[0], 2) + Math.pow(n[1] - e[1], 2)) > 3 && (e = n,
                                !0)
                            })
                        }
                    }),
                    I[0] = radial_center + radius / x,
                    I[1] = radial_center + radius / x
                } else
                    g(),
                    draw_branch = Z,
                    right_most_leaf = 0,
                    Y.forEach(function(t) {
                        if (t.x *= G[0],
                        t.y *= G[1],
                        "right-to-left" == F.layout && (t.y = e[1][1] * G[1] - t.y),
                        l(t) && (right_most_leaf = Math.max(right_most_leaf, t.y + et.node_bubble_size(t))),
                        t.collapsed) {
                            ...
                            t.collapsed = t.collapsed.filter(function(e, r) {
                                return r < 3 || r > t.collapsed.length - 4 || e[0] - n > 3 && (n = e[0],
                                !0)
                            })
                        }
                    });
                if (draw_scale_bar) {
                    var A, D;
                    if (et.radial()) {
                        if (D = Math.min(radius / 5, 50),
                        (D = (A = Math.pow(10, Math.ceil(Math.log(e[1][1] * D / radius) / Math.log(10)))) * (radius / e[1][1])) < 30) {
                        ...
                        A = e[1][1],
                        D = I[1] - Q[1] - F["left-offset"];
                    var C = d3.scale.linear().domain([0, A]).range([shown_font_size, shown_font_size + D])
                      , k = d3.format(".2g");
                    if (draw_scale_bar = d3.svg.axis().scale(C).orient("top").tickFormat(function(t) {
                        return 0 === t ? "" : k(t)
                    }),
                    et.radial())
                        draw_scale_bar.tickValues([A]);
                    else {
                        var L = C.ticks();
                        L = L.length > 1 ? L[1] : L[0],
                        draw_scale_bar.ticks(Math.min(10, d3.round(D / (shown_font_size * k(L).length * .8), 0)))
                    }
                } else
                    draw_scale_bar = null;
                return et
            ...
            et.size = function(t) {
                ...
                "fixed-step" != F["top-bottom-spacing"] && (I[0] = N[0]),
                "fixed-step" != F["left-right-spacing"] && (I[1] = N[1]),
                arguments.length ? et : I
            }
            ,
            ...
            et.selection_label = function(t) {
                return arguments.length ? (selection_attribute_name = t,
                et.sync_edge_labels(),
                et) : selection_attribute_name
            }
            ,
            et.handle_node_click = function(t) {
                var e = d3.select(A.container).select("#d3_layout_phylotree_context_menu");
                if (e.empty() && (e = d3.select(A.container).append("ul").attr("id", "d3_layout_phylotree_context_menu").attr("class", "dropdown-menu").attr("role", "menu")),
                e.selectAll("li").remove(),
                t) {
                    l(t) || (F.collapsible && (e.append("li").append("a").attr("tabindex", "-1").text(f(t) ? "Expand Subtree" : "Collapse Subtree").on("click", function(n) {
                        e.style("display", "none"),
                        et.toggle_collapse(t).update()
                    }),
                    e.append("li").attr("class", "divider"),
                    e.append("li").attr("class", "dropdown-header").text("Toggle selection")),
                    F.selectable && (e.append("li").append("a").attr("tabindex", "-1").text("All descendant branches").on("click", function(n) {
                        e.style("display", "none"),
                        et.modify_selection(et.select_all_descendants(t, !0, !0))
                    }),
                    e.append("li").append("a").attr("tabindex", "-1").text("All terminal branches").on("click", function(n) {
                        e.style("display", "none"),
                        et.modify_selection(et.select_all_descendants(t, !0, !1))
                    }),
                    e.append("li").append("a").attr("tabindex", "-1").text("All internal branches").on("click", function(n) {
                        e.style("display", "none"),
                        et.modify_selection(et.select_all_descendants(t, !1, !0))
                    }))),
                    t.parent && (F.selectable && (e.append("li").append("a").attr("tabindex", "-1").text("Incident branch").on("click", function(n) {
                        e.style("display", "none"),
                        et.modify_selection([t])
                    }),
                    e.append("li").append("a").attr("tabindex", "-1").text("Path to root").on("click", function(n) {
                        e.style("display", "none"),
                        et.modify_selection(et.path_to_root(t))
                    }),
                    (F.reroot || F.hide) && e.append("li").attr("class", "divider")),
                    F.reroot && e.append("li").append("a").attr("tabindex", "-1").text("Reroot on this node").on("click", function(n) {
                        e.style("display", "none"),
                        et.reroot(t).update()
                    }),
                    F.hide && e.append("li").append("a").attr("tabindex", "-1").text("Hide this " + (l(t) ? "node" : "subtree")).on("click", function(n) {
                        e.style("display", "none"),
                        et.modify_selection([t], "notshown", !0, !0).update_has_hidden_nodes().update()
                    })),
                    h(t) && e.append("li").append("a").attr("tabindex", "-1").text("Show all descendant nodes").on("click", function(n) {
                        e.style("display", "none"),
                        et.modify_selection(et.select_all_descendants(t, !0, !0), "notshown", !0, !0, "false").update_has_hidden_nodes().update()
                    });
                    var n = [];
                    "menu_items"in t && "object" == typeof t.menu_items && t.menu_items.forEach(function(e) {
                        3 == e.length && (e[2] && !e[2](t) || n.push([e[0], e[1]]))
                    }),
                    n.length && (e.append("li").attr("class", "divider"),
            ...
            et.style_nodes = function(t) {
                return arguments.length ? (node_styler = t,
                et) : node_styler
            }
            ,
            et.style_edges = function(t) {
                return arguments.length ? (edge_styler = t.bind(this),
                et) : edge_styler
            }
            ,
            ...
            et.update_layout = function(e, n) {
                ...
                r = et,
                i = new CustomEvent(t,{
                    detail: ["layout", r, r.layout_handler()]
                }),
            ...
            et.sync_edge_labels = function() {
                if (z.forEach(function(t) {
                    t[selection_attribute_name] = t.target[selection_attribute_name] || !1,
                    t.tag = t.target.tag || !1
                }),
                m(et),
                et.count_handler()) {
                    var t = {};
                    ...
                    t.tagged = z.reduce(function(t, e) {
                        return t + (u(e) ? 1 : 0)
                    }, 0),
                    b(et, t, et.count_handler())
                }
            }
            ,
            ...
            et.modify_selection = function(t, e, n, r, i) {
                if (e = e || selection_attribute_name,
                i = i || "toggle",
                F["restricted-selectable"].length) {
                    if (!_.contains(_.keys(this.predefined_selecters), t))
                        return;
                ...
                if (!F["restricted-selectable"] && !F.selectable || F["binary-selectable"]) {
                    if (F["binary-selectable"] && ("function" == typeof t ? z.forEach(function(n) {
                        ...
                        o = !0,
                        n.target[e] = r),
                        F["attribute-list"].forEach(function(t) {
                            t != e && !0 === n[e] && (n[t] = !1,
                            n.target[t] = !1)
                        })
                    ...
                    z.forEach(function(t) {
                        t[e] = t.target[e],
                        F["attribute-list"].forEach(function(n) {
                            n != e && !0 !== t[e] && (t[n] = !1,
                            t.target[n] = !1)
                        })
                    })),
                    o)) {
                        if (r || m(et),
                        et.count_handler())
                            (s = {})[e] = z.reduce(function(t, n) {
                                return t + (n[e] ? 1 : 0)
                            }, 0),
                            b(et, s, et.count_handler());
                        n && et.placenodes()
                    }
                } else {
                    var o = !1;
                ...
                return U && "tag" != e && U(et.get_selection()),
                et
            }
            ,
            ...
            ,
            et.is_leafnode = l,
            et.radial = function(t) {
                return arguments.length ? (F["is-radial"] = t,
                et) : F["is-radial"]
            }
            ,
            et.align_tips = function(t) {
                return arguments.length ? (F["align-tips"] = t,
                et) : F["align-tips"]
            }
            ,
            ...
            et.shift_tip = function(t) {
                return F["is-radial"] ? [("end" == t.text_align ? -1 : 1) * (radius_pad_for_bubbles - t.radius), 0] : (F["right-to-left"],
                [right_most_leaf - t.screen_x, 0])
            }
            ,
            ...
            et.count_handler = function(t) {
                return arguments.length ? (count_listener_handler = t,
                et) : count_listener_handler
            }
            ,
            et.layout_handler = function(t) {
                return arguments.length ? (layout_listener_handler = t,
                et) : layout_listener_handler
            }
            ,
            et.internal_label = function(t, n) {
                ...
                et.modify_selection(function(t, e) {
                    return l(t.target),
                    t.target[selection_attribute_name]
                })
            }
            ,
            et.max_parsimony = function(t) {
                ...
                function t(e) {
                    if (e.mp = [[0, 0], [!1, !1]],
                    l(e))
                        e.mp[1][0] = e.mp[1][1] = e[selection_attribute_name] || !1,
                        e.mp[0][0] = e.mp[1][0] ? 1 : 0,
                        e.mp[0][1] = 1 - e.mp[0][0];
                    else {
                        ...
                        e[selection_attribute_name] ? (e.mp[0][0] = r + 1,
                        e.mp[1][0] = !0,
                        e.mp[0][1] = r,
                        e.mp[1][1] = !0) : (n < r + 1 ? (e.mp[0][0] = n,
                        e.mp[1][0] = !1) : (e.mp[0][0] = r + 1,
                        e.mp[1][0] = !0),
                        r < n + 1 ? (e.mp[0][1] = r,
                        e.mp[1][1] = !0) : (e.mp[0][1] = n + 1,
                        e.mp[1][1] = !1))
                    }
                }(Y[0]),
                Y.forEach(function(t) {
                ...
                if (t.parent && Y.indexOf(t) >= 0) {
                    var i = t.parent.children.indexOf(t)
                      ...
                      , s = {
                        name: e,
                        parent: o,
                        attribute: r ? r[1] : null,
                        original_child_order: 2
                    };
                    o.children = [t, s],
                    t.parent.children[i] = o,
                    t.parent = o,
                    t.attribute = r ? r[0] : null,
                    t.original_child_order = 1,
                    et.update_layout(Y[0], !0)
                }
                return et
            }
            ,
            et.delete_a_node = function(t) {
                if ("number" != typeof t)
                    return et.delete_a_node(Y.indexOf(t));
                if (t > 0 && t < Y.length) {
                    var e = Y[t];
                    if (e.parent) {
                        ...
                        e.children && e.children.forEach(function(t) {
                            t.original_child_order = e.parent.children.length,
                            e.parent.children.push(t),
                            t.parent = e.parent
                        }),
                        e.parent.children.length > 2 ? e.parent.children.splice(n, 1) : e.parent.parent ? (e.parent.parent.children[e.parent.parent.children.indexOf(e.parent)] = e.parent.children[1 - n],
                        e.parent.children[1 - n].parent = e.parent.parent,
                        Y.splice(Y.indexOf(e.parent), 1)) : (Y.splice(0, 1),
                        Y[0].parent = null,
                        delete Y[0].attribute,
                        delete Y[0].annotation,
                        delete Y[0].original_child_order,
                        Y[0].name = "root"),
                        et.update_layout(Y[0], !0))
                    }
                }
            ...
            et.reroot = function(t) {
                if (t.parent) {
                    ...
                    _.noop());
                    if (n.parent) {
                        for (t.__mapped_bl = void 0 === t.__mapped_bl ? void 0 : .5 * t.__mapped_bl,
                        r = n.__mapped_bl,
                        n.__mapped_bl = t.__mapped_bl,
                        new_json.children.push(n); n.parent; ) {
                            var i = n.children.indexOf(e);
                            n.parent.parent ? n.children.splice(i, 1, n.parent) : n.children.splice(i, 1);
                            var o = n.parent.__mapped_bl;
                            void 0 !== o && (n.parent.__mapped_bl = r,
                            r = o),
                            e = n,
                            n = n.parent
                        }
                    ...
                    if (1 == n.children.length)
                        r && (n.children[0].__mapped_bl += r),
                        e.children = e.children.concat(n.children);
                    else {
                        var s = {
                            name: "__reroot_top_clade"
                        };
                        s.__mapped_bl = r,
                        s.children = n.children.map(function(t) {
                            return t
                        }),
                        e.children.push(s)
                    }
            ...
            et.spacing_x = function(t, e) {
                return arguments.length ? (X[0] != t && t >= F["minimum-per-node-spacing"] && t <= F["maximum-per-node-spacing"] && (X[0] = t,
                e || et.placenodes()),
                et) : X[0]
            }
            ,
            et.spacing_y = function(t, e) {
                return arguments.length ? (X[1] != t && t >= F["minimum-per-level-spacing"] && t <= F["maximum-per-level-spacing"] && (X[1] = t,
                e || et.placenodes()),
                et) : X[1]
            }
            ,
            et.toggle_collapse = function(t) {
                if (t.collapsed) {
                    t.collapsed = !1;
                    var e = function(t) {
                        l(t) || t.collapsed || t.children.forEach(e),
                        t.hidden = !1
                    };
                    e(t)
                } else
            ...
            et.update_has_hidden_nodes = function() {
                for (k = Y.length - 1; k >= 0; k -= 1)
                    l(Y[k]) ? Y[k].has_hidden_nodes = Y[k].notshown : Y[k].has_hidden_nodes = Y[k].children.reduce(function(t, e) {
                        return e.notshown || t
                    }, !1);
                return et
            }
            ,
            et.branch_length = function(t) {
                return arguments.length ? (P = t || C,
                et) : P
            }
            ,
            et.branch_name = function(t) {
                return arguments.length ? (R = t || L,
                et) : R
            }
            ,
            et.length = function(t) {
                return arguments.length ? (default_length_attribute != t && (default_length_attribute = t,
                M = !0),
                et) : default_length_attribute
            }
            ,
            et._label_width = function(t) {
                ...
                return Y.filter(n).forEach(function(n) {
                    ...
                    null !== n.angle && (r *= Math.max(Math.abs(Math.cos(n.angle)), Math.abs(Math.sin(n.angle)))),
                    e = Math.max(r, e)
                }),
                e
            }
            ...
            et.font_size = function(t) {
                return arguments.length ? (H = void 0 === t ? 12 : t,
                et) : H
            }
            ,
            et.scale_bar_font_size = function(t) {
                return arguments.length ? (K = void 0 === t ? 12 : t,
                et) : K
            }
            ,
            et.node_circle_size = function(t, e) {
                return arguments.length ? (F.node_circle_size = d3.functor(void 0 === t ? 3 : t),
                et) : F.node_circle_size
            }
            ,
            ...
            et.svg = function(t) {
                ...
                "phylotree-container" == j["tree-container"] && (B.selectAll("*").remove(),
                svg_defs = B.append("defs")),
                d3.select(A.container).on("click", function(t) {
            ...
            et.update = function(t) {
                ...
                if (r.enter().append("g").attr("class", j["tree-container"]),
                ...
                draw_scale_bar) {
                    ...
                    i.enter().append("g"),
                    i.attr("class", j["tree-scale-bar"]).style("font-size", J(K)).attr("transform", function(t) {
                        return E([Q[1] + F["left-offset"], et.pad_height() - 10])
                    }).call(draw_scale_bar),
                    i.selectAll("text").style("text-anchor", "end")
                } else
                    B.selectAll("." + j["tree-scale-bar"]).remove();
                var o = r.selectAll(d(j)).data(z.filter(s), function(t) {
                    return t.target.id || (t.target.id = ++e)
                });
                t ? o.exit().transition().remove() : o.exit().remove(),
                o.enter().insert("path", ":first-child"),
                o.each(function(e) {
                ...
                var a = r.selectAll(y(j)).data(Y.filter(f), function(t) {
                  ...
                  , h = _.noop();
                if (et.radial()) {
                    u = d3.svg.line().interpolate(function(t) {
                        t.pop();
                        var e = t.shift()
                          , n = t.join("L")
                    ...
                    u = d3.svg.line().interpolate("basis").y(function(t) {
                        return t[0]
                    }).x(function(t) {
                        return t[1]
                    }),
                ...
                t ? (a.enter().insert("path", ":first-child"),
                a.attr("class", j.clade).attr("d", function(t) {
                    if (t.collapsed_clade)
                ...
                })) : (a.enter().insert("path", ":first-child"),
                a.attr("class", j.clade).attr("d", function(t) {
                    return t.collapsed_clade = u(t.collapsed)
                }));
                ...
                g.enter().append("g");
                t ? (g.exit().transition().remove(),
                g = g.attr("transform", function(t) {
                    if (!_.isUndefined(t.screen_x) && !_.isUndefined(t.screen_y))
                        return "translate(" + t.screen_x + "," + t.screen_y + ")"
                }).transition()) : g.exit().remove(),
                g.attr("transform", function(t) {
                    const e = "right-to-left" == F.layout && l(t);
                    return t.screen_x = q(t),
                    t.screen_y = W(t),
                    E([e ? 0 : t.screen_x, t.screen_y])
                ...
                if (F.brush) {
                    ...
                    var w = d3.svg.brush().x(d3.scale.identity().domain([0, m[0] - Q[1] - F["left-offset"]])).y(d3.scale.identity().domain([0, m[1] - et.pad_height()])).on("brush", function() {
                        var t = d3.event.target.extent()
                        ...
                        et.modify_selection(z.map(function(t) {
                            return t.target
                        }), "tag", !1, e.length > 0, "false"),
                        et.modify_selection(e, "tag", !1, !1, "true")
                    }).on("brushend", function() {
                        b.call(d3.event.target.clear())
                    });
                    b.call(w)
                }
                if (et.sync_edge_labels(),
                F.zoom) {
                    var v = d3.behavior.zoom().scaleExtent([.1, 10]).on("zoom", function() {
                        var t = d3.event.translate;
                        t[0] += Q[1] + F["left-offset"],
                        t[1] += et.pad_height(),
                        d3.select("." + j["tree-container"]).attr("transform", "translate(" + t + ")scale(" + d3.event.scale + ")")
                    });
                    B.call(v)
                }
                return et
            ...
            et.layout = function(t) {
                return B ? (B.selectAll("." + j["tree-container"] + ",." + j["tree-scale-bar"] + ",." + j["tree-selection-brush"]),
                et.update(t)) : et
            }
            ,
            et.refresh = function() {
                var t = B.selectAll("." + j["tree-container"])
                  , e = t.selectAll(d(j));
                e.attr("class", et.reclass_edge),
                edge_styler && e.each(function(t) {
                    edge_styler(d3.select(this), t)
                });
                var n = t.selectAll(p(j));
                n.attr("class", et.reclass_node),
                node_styler && n.each(function(t) {
                    node_styler(d3.select(this), t)
                })
            }
            ,
            et.reclass_edge = function(t) {
                var n = j.branch;
                return u(t) && (n += " " + j["tagged-branch"]),
                e(t, selection_attribute_name) && (n += " " + j["selected-branch"]),
                n
            }
            ,
            et.reclass_node = function(t) {
                var n = j[l(t) ? "node" : "internal-node"];
                return u(t) && (n += " " + j["tagged-node"]),
                e(t, selection_attribute_name) && (n += " " + j["selected-node"]),
                (f(t) || h(t)) && (n += " " + j["collapsed-node"]),
                n
            }
            ,
            et.select_all_descendants = function(t, e, n) {
                var r = [];
                return function i(o) {
                    l(o) ? e && o != t && r.push(o) : (n && o != t && r.push(o),
            ...
            et.draw_edge = function(t, e, n) {
                (t = d3.select(t)).attr("class", et.reclass_edge).on("click", function(t) {
                ...
                t.transition().attr("d", r)) : t.attr("d", r),
                e.existing_path = r;
                var i = P(e.target);
                if (void 0 !== i) {
                    var o = t.selectAll("title");
                    o.empty() && (o = t.append("title")),
                    o.text("Length = " + i)
                } else
                    t.selectAll("title").remove();
                return edge_styler && edge_styler(t, e),
                et
            }
            ,
            ...
            et.draw_node = function(t, e, n) {
                ...
                l(e)) {
                    var r = t.selectAll("text").data([e])
                      , i = t.selectAll("line");
                    if (n ? r.enter().append("text").style("opacity", 0).transition().style("opacity", 1) : r.enter().append("text"),
                    ...
                    et.align_tips() ? (i = i.data([e]),
                    n ? (i.enter().append("line").style("opacity", 0).transition().style("opacity", 1),
                    i.attr("x1", function(t) {
                        return ("end" == t.text_align ? -1 : 1) * et.node_bubble_size(e)
                    }).attr("x2", 0).attr("y1", 0).attr("y2", 0),
                    i.transition().attr("x2", function(t) {
                    ...
                    i.classed(j["branch-tracer"], !0)) : i.remove(),
                    F["draw-size-bubbles"]) {
                        var o = et.node_bubble_size(e);
                        (s = t.selectAll("circle").data([o])).enter().append("circle"),
                        n && (s = s.transition()),
                        s.attr("r", function(t) {
                            return t
                        }),
                ...
                return node_styler && node_styler(t, e),
                e
            }
            ,
            ...
            ,
            d3.rebind(et, D, "sort", "children", "value"),
            et.nodes = et,
            et.links = d3.layout.cluster().links,
            et
        }
        ,
        d3.layout.phylotree.is_leafnode = l,
        d3.layout.phylotree.add_custom_menu = function(t, e, n, r) {
            "menu_items"in t || (t.menu_items = []),
            t.menu_items.some(function(t) {
                return t[0] == e && t[1] == n && t[2] == r
            }) || t.menu_items.push([e, n, r])
        }
        ,
        d3.layout.phylotree.trigger_refresh = m,
        d3.layout.phylotree.nexml_parser = function(t) {
            var e;
            return i(t, function(t, n) {
                e = n["nex:nexml"].trees[0].tree.map(function(t) {
                    var e = t.node.map(t=>t.$)
                      ...
                      , r = e.filter(t=>t.root)
                      , i = r > 0 ? r[0].id : e[0].id;
                    return n[i].name = "root",
                    t.edge.map(t=>t.$).forEach(function(t) {
                        n[t.source].edges.push(t)
                    }),
                    function t(e, r) {
                        if (e.edges) {
                            var i = _.pluck(e.edges, "target");
                            e.children = _.values(_.pick(n, i)),
